...
public class PostFeignClientConfig {
    ...
    public PostFeignClient postFeignClient(
        ...
        FeignDecorators feignDecorators = FeignDecorators.builder()
                .withRetry(retryRegistry.retry("contentService"))
                .withCircuitBreaker(circuitBreakerRegistry.circuitBreaker("contentService"))
                .withRateLimiter(rateLimiterRegistry.rateLimiter("contentService"))
                .build();
