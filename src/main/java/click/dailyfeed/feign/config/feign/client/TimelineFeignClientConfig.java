...
@Configuration
public class TimelineFeignClientConfig {
    @Value("${dailyfeed.services.timeline.feign.url}")
    private String timelineUrl;

    @Bean
    public TimelineFeignClient timelineFeignClient(
        ...
        FeignDecorators feignDecorators = FeignDecorators.builder()
                .withRetry(retryRegistry.retry("timelineService"))
                .withCircuitBreaker(circuitBreakerRegistry.circuitBreaker("timelineService"))
                .withRateLimiter(rateLimiterRegistry.rateLimiter("timelineService"))
                .build();
        ...
        return Resilience4jFeign
                ...
                .target(TimelineFeignClient.class, timelineUrl);
    }
}
